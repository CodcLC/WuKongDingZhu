...
var s = t("BulletBase"),
    ...
    d = (function (t) {
        function e() {
            ...
            return (e.img = null), (e.shouji_sp = null), (e.attack_colider = null), e;
        }
        return (
            i(e, t),
            ...
            (e.prototype.InitOther = function () {
                (this.attack_colider.tag = this.belong_fight.data.index),
                    ...
                    (this.attack_colider.node.attack_type = "Boom"),
                    (this.attack_colider.node.fight = this.belong_fight),
                    cc.tween(this.img.node).to(0.2, {scale: 1}).start(),
            ...
            (e.prototype.OnHitOver = function () {
                var t = this;
                cc.tween(this.img.node).to(0.2, {scale: 0}).start(),
                    (this.shouji_sp.node.active = !0),
                    this.shouji_sp.setAnimation(0, "lv" + this.belong_fight.lv, !1),
