...
var s = t("BulletBase"),
    ...
    d = (function (t) {
        function e() {
            ...
            return (e.bullet_sp = null), (e.shouji_sp = null), e;
        }
        return (
            i(e, t),
            (e.prototype.start = function () {
                this.bullet_sp.setAnimation(0, "lv" + this.belong_fight.lv, !0);
            }),
            (e.prototype.InitOther = function () {
                cc.tween(this.bullet_sp.node).to(0.2, {scale: 1}).start(), (this.shouji_sp.node.active = !1);
            }),
